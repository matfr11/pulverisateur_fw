...
"<h2>AUTOMATE</h2>"
"<div class='control-card'>"
"<button id='mode_tr' class='btn-full' onclick=\"api('avant','auto_transfert','A')\">LANCER TRANSFERT</button>"
"<div class='h-gauge-container'>"
"<div id='jFillTr' class='h-gauge-fill' style='background:#39f'></div>"
"<div id='jTextTr' class='h-gauge-text'>-- / -- L</div>"
"</div></div>"
"<div class='control-card'>"
"<button id='mode_br' class='btn-full' onclick=\"api('avant','auto_brassage','A')\">AUTO BRASSAGE</button>"
"<div class='h-gauge-container'>"
