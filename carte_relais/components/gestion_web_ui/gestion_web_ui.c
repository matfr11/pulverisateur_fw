...
"[data-theme=light]{--bg:#f0f2f5;--bg2:#fff;--bg3:#f7f7f7;--bg4:#eee;--bg5:#f0f0f0;"
"--brd:#ddd;--brd2:#e0e0e0;--brd3:#bbb;--txt:#111;--txt2:#222;--txt3:#aaa;"
"--ico:#555;--btn:#e0e0e0;--gbg:#ddd;--lbl:#444;--lbl2:#777}"
...
static esp_err_t handler_page_settings(httpd_req_t *req)
{
    ...
    int len = snprintf(page, 14336,
        ...
        "<div class='ver-info'>CONFIG v3.0.0</div>"
